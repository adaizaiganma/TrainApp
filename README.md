...
---
# Getting started
1. Download the app from release
2. Go to https://tdx.transportdata.tw/ and apply for an account.
   Would take up to 2-3 working days for them to verify.
...
---
# Functions
- It just works as a basic and clean time scheduler.
- Favourite route on home page. No need to click for multiple times when you are in emergency.
- Clean interface. No more Taiwan shit web and app design.
---
# Screenshots
<p align="center">
